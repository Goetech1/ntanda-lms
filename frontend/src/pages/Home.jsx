...
const Home = () => {
  ...
  return (
    <div className="academic-theme min-h-screen bg-[#FAF9F6] text-[#1E1E1E] selection:bg-[#002147] selection:text-white">
      {/* Top Utility Bar */}
      <div className="bg-[#002147] text-white py-2 px-margin-mobile md:px-margin-desktop text-xs font-medium border-b border-white/10 flex justify-between items-center z-50 relative">
      ...
      <header className="sticky top-0 w-full z-50 bg-[#FAF9F6]/95 backdrop-blur-md border-b border-[#002147]/20 shadow-sm transition-all duration-300">
        <nav className="flex justify-between items-center px-margin-mobile md:px-margin-desktop h-24 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-md">
            <img 
              ...
              className="h-12 w-12 rounded-none border border-[#002147] object-cover" 
            />
            <div className="flex flex-col">
              <span className="font-serif-academic text-2xl md:text-3xl font-extrabold text-[#002147] tracking-tight leading-none">
                {tenant?.name || "Ntanda"}
              </span>
          ...
          <div className="hidden md:flex items-center gap-xl">
            <Link to="/courses" className="text-[#1E1E1E] font-serif-academic font-medium hover:text-[#002147] transition-colors duration-200 text-lg">
              Browse Programs
            </Link>
            <Link to="/courses" className="text-[#1E1E1E] font-serif-academic font-medium hover:text-[#002147] transition-colors duration-200 text-lg">
              Schools &amp; Faculty
          ...
          <div className="hidden md:flex items-center gap-md">
            <Link to="/login" className="text-[#002147] border border-[#002147] hover:bg-[#002147] hover:text-white font-serif-academic font-bold px-lg py-sm transition-all duration-200 text-base">
              Sign In
            </Link>
            <Link to="/register" className="bg-[#002147] text-white hover:bg-[#001229] font-serif-academic font-bold px-lg py-sm transition-all duration-200 text-base shadow-sm border border-[#002147]">
              Register
            </Link>
          </div>
          ...
          <div className="flex md:hidden items-center">
            <button 
              ...
              className="w-12 h-12 flex items-center justify-center border border-[#002147]/30 hover:bg-[#002147]/5 text-[#002147] transition-all"
            >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-[#002147]/20 bg-[#FAF9F6] px-margin-mobile py-lg flex flex-col gap-md shadow-lg animate-fade-up">
            <Link to="/courses" onClick={() => setIsMobileMenuOpen(false)} className="text-[#1E1E1E] font-serif-academic text-lg py-xs hover:text-[#002147] border-b border-neutral-200 pb-2">Browse Programs</Link>
            <Link to="/courses" onClick={() => setIsMobileMenuOpen(false)} className="text-[#1E1E1E] font-serif-academic text-lg py-xs hover:text-[#002147] border-b border-neutral-200 pb-2">Schools &amp; Faculty</Link>
            <Link to="/courses" onClick={() => setIsMobileMenuOpen(false)} className="text-[#1E1E1E] font-serif-academic text-lg py-xs hover:text-[#002147] border-b border-neutral-200 pb-2">Research</Link>
            <div className="flex gap-sm mt-md">
              <Link to="/login" onClick={() => setIsMobileMenuOpen(false)} className="flex-1 text-center border border-[#002147] text-[#002147] font-serif-academic font-bold py-sm hover:bg-[#002147]/5">Sign In</Link>
              <Link to="/register" onClick={() => setIsMobileMenuOpen(false)} className="flex-1 text-center bg-[#002147] text-white font-serif-academic font-bold py-sm hover:bg-[#001229]">Get Started</Link>
            </div>
          </div>
        )}
      </header>
      ...
      <main>
        ...
        <section className="relative min-h-[550px] md:min-h-[700px] flex items-center bg-[#1E1E1E] overflow-hidden">
          ...
          <div className="container mx-auto px-margin-mobile md:px-margin-desktop relative z-10 py-xl max-w-7xl">
            <div className="max-w-3xl bg-[#FAF9F6] border-t-8 border-[#002147] p-lg md:p-2xl shadow-2xl relative">
              ...
              <div className="flex flex-col sm:flex-row gap-md">
                <Link to="/register" className="bg-[#002147] hover:bg-[#001229] text-white font-serif-academic font-bold px-xl py-md text-center transition-colors duration-200">
                  Apply Online
                </Link>
                <Link to="/courses" className="border border-[#002147] text-[#002147] hover:bg-[#002147]/5 font-serif-academic font-bold px-xl py-md text-center transition-colors duration-200">
        ...
        <section className="bg-[#FAF9F6] py-20 border-b border-[#002147]/10">
          <div className="container mx-auto px-margin-mobile md:px-margin-desktop max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-xl items-center">
              <div className="lg:col-span-5 flex flex-col justify-center border-l-4 border-[#002147] pl-lg">
                ...
                <Link to="/courses" className="text-[#002147] hover:text-[#001229] font-serif-academic font-bold text-lg flex items-center gap-sm group">
              ...
              <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-lg">
                <div className="bg-white p-lg border border-neutral-200/60 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                  ...
                  <Link to="/courses" className="text-[#002147] text-sm font-bold font-serif-academic mt-lg hover:underline block">Read More &gt;</Link>
                </div>
                <div className="bg-white p-lg border border-neutral-200/60 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                  <div>
        ...
        <section className="py-24 bg-[#F3F1EC]">
          <div className="container mx-auto px-margin-mobile md:px-margin-desktop max-w-7xl">
            <div className="flex flex-col md:flex-row justify-between items-baseline mb-2xl border-b border-[#002147]/20 pb-md">
              <h2 className="font-serif-academic text-3xl md:text-5xl font-extrabold text-[#1E1E1E]">
                Featured Schools &amp; Programs
              </h2>
              <Link to="/courses" className="text-[#002147] hover:text-[#001229] font-serif-academic font-bold text-lg hover:underline mt-sm md:mt-0">
                View all faculties &gt;
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-xl">
              {/* Program 1 */}
              <article className="bg-white border-t-4 border-[#002147] shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col">
                <div className="h-56 bg-neutral-200 overflow-hidden relative">
                  <div className="absolute top-md left-md bg-[#002147] text-white font-serif-academic font-bold px-sm py-[2px] text-xs uppercase">
                    School of Computer Science
                  </div>
                  <div className="h-full w-full bg-[#002147]/10 flex items-center justify-center text-[#002147]">
                ...
                <div className="p-lg flex flex-col flex-grow">
                  ...
                  <div className="mt-auto pt-md border-t border-neutral-100 flex justify-between items-center">
                    ...
                    <Link to="/courses" className="bg-[#002147] text-white hover:bg-[#001229] font-serif-academic font-bold px-lg py-xs text-sm transition-colors">
                      Enroll
                    </Link>
                  </div>
                </div>
        ...
        <section className="bg-[#002147] text-white py-24">
        ...
        <section className="py-24 bg-[#FAF9F6]">
          <div className="container mx-auto px-margin-mobile md:px-margin-desktop max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-xl">
              <div className="bg-white p-xl border-l-4 border-[#002147] shadow-sm flex flex-col justify-between">
                ...
                <div className="flex items-center gap-md">
                  <div className="w-14 h-14 rounded-full bg-neutral-200 overflow-hidden border border-[#002147]">
                    <img 
                      className="w-full h-full object-cover" 
                      alt="Chanda M." 
      ...
      {/* Footer */}
      <footer className="bg-[#1E1E1E] text-[#FAF9F6] border-t-8 border-[#002147]">
