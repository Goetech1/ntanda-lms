...
let AiController = class AiController {
    ...
    async askTutor(req, body) {
        return this.aiService.askTutor(req.tenantId, req.user.id, body.question, body.courseId);
    }
    async generateQuiz(req, body) {
        return this.aiService.generateQuiz(req.tenantId, req.user.id, body.topic, body.questionCount, body.difficulty);
    }
...
], AiController.prototype, "askTutor", null);
__decorate([
    (0, common_1.Post)('quiz-generator'),
