...
const academic_records_controller_1 = require("./controllers/academic-records.controller");
...
exports.AcademicRecordsModule = AcademicRecordsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [academic_records_service_1.AcademicRecordsService],
        exports: [academic_records_service_1.AcademicRecordsService],
    })
